...
use cw_pepperwatch::{ExecuteMsg, Extension, InstantiateMsg, MinterResponse, QueryMsg, CountResponse, KeyResponse, PublicKeyResponse, BalanceResponse,
    PriceResponse, WithdrawResponse};
...
fn main() {
    ...
    export_schema(&schema_for!(PublicKeyResponse), &out_dir);
    export_schema(&schema_for!(BalanceResponse), &out_dir);
    export_schema(&schema_for!(PriceResponse), &out_dir);
    export_schema(&schema_for!(WithdrawResponse), &out_dir);
}